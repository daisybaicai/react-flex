...
const TreemapVisual = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('treemap-visual'));
...
$.get(ROOT_PATH + 'data/asset/data/obama_budget_proposal_2012.json', function (obama_budget_2012) {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('treemap-visual');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="treemap-visual"></div>;
};

export default TreemapVisual;
