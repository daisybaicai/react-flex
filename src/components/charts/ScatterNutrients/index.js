...
const ScatterNutrients = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('scatter-nutrients'));
...
app.configParameters = {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('scatter-nutrients');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="scatter-nutrients"></div>;
};

export default ScatterNutrients;
