...
setInterval(function () {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('pictorialBar-forest');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="pictorialBar-forest"></div>;
};

export default PictorialBarForest;
