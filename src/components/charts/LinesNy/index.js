...
const LinesNy = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('lines-ny'));
...
fetchData(0);
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('lines-ny');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="lines-ny"></div>;
};

export default LinesNy;
