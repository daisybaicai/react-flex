...
setInterval(function () {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('pictorialBar-spirit');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="pictorialBar-spirit"></div>;
};

export default PictorialBarSpirit;
