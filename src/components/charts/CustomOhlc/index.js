...
const CustomOhlc = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('custom-ohlc'));
...
$.get(ROOT_PATH + 'data/asset/data/stock-DJI.json', function (rawData) {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('custom-ohlc');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="custom-ohlc"></div>;
};

export default CustomOhlc;
