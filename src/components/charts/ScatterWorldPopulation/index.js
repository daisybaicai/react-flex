...
const ScatterWorldPopulation = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('scatter-world-population'));
...
option = {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('scatter-world-population');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="scatter-world-population"></div>;
};

export default ScatterWorldPopulation;
