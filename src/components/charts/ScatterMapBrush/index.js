...
const ScatterMapBrush = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('scatter-map-brush'));
...
function renderBrushed(params) {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('scatter-map-brush');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="scatter-map-brush"></div>;
};
