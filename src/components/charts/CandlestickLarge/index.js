...
const CandlestickLarge = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('candlestick-large'));

    // 指定图表的配置项和数据
    var var upColor = '#ec0000';
...
function generateOHLC(count) {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('candlestick-large');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="candlestick-large"></div>;
};

export default CandlestickLarge;
