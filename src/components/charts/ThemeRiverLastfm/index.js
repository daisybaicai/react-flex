...
const ThemeRiverLastfm = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('themeRiver-lastfm'));
...
option = {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('themeRiver-lastfm');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="themeRiver-lastfm"></div>;
};
