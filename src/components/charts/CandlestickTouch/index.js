...
const CandlestickTouch = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('candlestick-touch'));
...
option = {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('candlestick-touch');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="candlestick-touch"></div>;
};
