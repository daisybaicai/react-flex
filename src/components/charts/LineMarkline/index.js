...
const LineMarkline = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('line-markline'));
...
var option = {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('line-markline');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="line-markline"></div>;
};

export default LineMarkline;
