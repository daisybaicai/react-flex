...
const ParallelNutrients = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('parallel-nutrients'));
...
function getOption(data) {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('parallel-nutrients');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="parallel-nutrients"></div>;
};
