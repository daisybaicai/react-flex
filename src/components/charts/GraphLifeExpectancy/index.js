...
const GraphLifeExpectancy = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('graph-life-expectancy'));
...
$.get(ROOT_PATH + 'data/asset/data/life-expectancy.json', function (data) {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('graph-life-expectancy');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="graph-life-expectancy"></div>;
};

export default GraphLifeExpectancy;
