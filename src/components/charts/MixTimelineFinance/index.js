...
const MixTimelineFinance = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('mix-timeline-finance'));
...
option = {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('mix-timeline-finance');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="mix-timeline-finance"></div>;
};
