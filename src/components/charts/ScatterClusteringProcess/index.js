...
const ScatterClusteringProcess = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('scatter-clustering-process'));
...
function getOption(result, k) {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('scatter-clustering-process');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="scatter-clustering-process"></div>;
};

export default ScatterClusteringProcess;
