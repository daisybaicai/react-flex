...
option = {
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('pictorialBar-hill');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="pictorialBar-hill"></div>;
};

export default PictorialBarHill;
