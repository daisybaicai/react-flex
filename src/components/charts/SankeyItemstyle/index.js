...
const SankeyItemstyle = () => {
  const renderChart = () => {
    var myChart = echarts.init(document.getElementById('sankey-itemstyle'));
...
option ={
  ...
  useEffect(() => {
    ...
    return () => {
      echarts.disConnect('sankey-itemstyle');
    };
  }, []);

  return <div style={{ width: '400px', height: '400px' }} id="sankey-itemstyle"></div>;
};

export default SankeyItemstyle;
